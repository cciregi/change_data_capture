    ...
    private void handleChangeEvent(RecordChangeEvent<SourceRecord> sourceRecordRecordChangeEvent) {
        ...
        if (sourceRecordValue != null) {
            try {
                ...
                Long documentId = HandlerUtils.getDocumentId(sourceRecordKey);
                String table = HandlerUtils.getTable(sourceRecordValue);
                Map<String, Object> product = HandlerUtils.getData(sourceRecordValue);

                log.info("Table : {} , DocumentId : {} , Operation : {} , Product : {}", table, documentId, operation, product);

                productService.handleEvent(operation, documentId, table, product);
            } catch (IOException e) {
